...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      "Buscador manual: 5 búsquedas al mes para probarlo",
      "Reporte «¿A qué precio ofertar?» — en todos los planes",
      "Mis licitaciones, en versión básica · hasta 10",
      "Competencia · Mercado actual (básico) · historial 1 mes",
    ],
  },
  {
    name: "Ventaja",
    ...
    features: [
      ...
      "Las 10 mejores del día + 30 búsquedas al mes (manual, sondeos y PAA)",
      ...
      "Sondeos (RFI) y Plan anual (PAA): lo que se planea antes del pliego",
              "Competencia · Mercado histórico desde 2023 · 3 usuarios",
    ],
  },
  {
    name: "Dominio",
    ...
    features: [
      ...
      "Mis licitaciones sin tope + exportar TODO el historial · 5 usuarios",
      "Competencia — empresas, contratantes y tu mercado",
              "Capacidad Residual (K): cuánto puedes seguir contratando",
      "Gestionar tus contratos: fases, pólizas, actas y avisos de vencimiento",
